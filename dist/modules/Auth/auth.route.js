...
router.post('/changeUserPassword', (0, auth_1.auth)('user', 'admin'), (0, validateRequest_1.default)(auth_validation_1.changeUserPasswordValidationSchema), auth_controller_1.AuthControllers.changeUserPassword);
